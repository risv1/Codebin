  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="w-1/2 h-fit border border-gray-500 shadow-lg shadow-gray-500 rounded-xl">
        <Tabs defaultValue="login" className="w-full p-3">
          <TabsList className="w-full h-2/3 flex justify-between">
            <TabsTrigger className="w-1/2" value="login">
              Login
            </TabsTrigger>
            <div onClick={()=>navigate("/register")} className="w-1/2 hover:cursor-pointer  text-base font-semibold flex justify-center items-center">
              Register
            </div>
          </TabsList>
